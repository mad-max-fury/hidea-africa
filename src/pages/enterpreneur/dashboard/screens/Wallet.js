      ...
      {withDrawFund ? (
        <VStack w="full" justifyContent="space-between" alignItems="flex-start">
          <Box w="full">
            ...
            >
              <AlertIcon />
              <Text fontSize="14px" color="#0E6898" fontWeight="400">
                Please note that a conversion fee of 20% would be charged on
                your withdrawals.
              </Text>
            </Alert>
            ...
            >
              ...
              >
                <HStack w="full" justifyContent="space-between" mb="32px">
                  ...
                  <Text color="secondary.100" fontSize="20px" fontWeight="700">
                    NGN 200,000,000
                  </Text>
                </HStack>
                <Spacer />
                ...
                <form style={{ width: "100%" }} onSubmit={onSubmit}>
                  ...
                  <CheckboxGroup colorScheme="green" size="lg">
                    <VStack spacing={[1, 5]} alignItems="flex-start">
                      <Checkbox value="save-beneficiary-details">
                        <Text>Save beneficiary details</Text>
                      </Checkbox>
                      <Checkbox value="confirm">
                        <Text>
                          I confirm receipient details entered here are correct
                          and valid.
                        </Text>
                      </Checkbox>
                    </VStack>
              ...
              <VStack alignItems="flex-start" spacing="24px" px="60px">
                ...
                <VStack alignItems="flex-start">
                  ...
                  <Text fontWeight="700">
                    Kudirat Bakare, 0022000358, First Bank
                  </Text>
                </VStack>
                ...
                <VStack alignItems="flex-start">
                  ...
                  <Text fontSize="25px" fontWeight="700" color="secondary.100">
                    NGN 20,040,000
                  </Text>
                </VStack>
              </VStack>
                  ...
                  <ModalBody>
                    <VStack alignItems="center" spacing="24px">
                      ...
                      >
                        ...
                        <Text fontSize="14px" color="#0E6898" fontWeight="400">
                          {" "}
                          Please enter your transaction PIN to finalize
                          withdrawl request.
                        </Text>
                      </Alert>
                      <Spacer />
                  ...
                  <ModalBody mb="56px">
                    <VStack alignItems="center" spacing="24px">
                      ...
                      <Text fontSize="14px" textAlign="center" fontWeight="400">
                        {" "}
                        Your withdrawal request has been sent.Funds would be
                        remitted in 10 minutes..
                      </Text>
                    </VStack>
                  </ModalBody>
                </ModalContent>
        ...
        <VStack w="full" justifyContent="space-between" alignItems="flex-start">
          ...
          <HStack w="100%">
            <VStack width={"70%"} padding="1rem">
              <Box h={"50vh"} width="100%" borderRadius={"20px"}>
          ...
          <HStack w="100%">
            ...
            >
              <HStack width="full" justifyContent="space-between" mt="1">
                ...
                {transactions > 0 ? (
                  <Text fontWeight="700" color="secondary.100">
                    View All
                  </Text>
                ) : null}
              </HStack>
                  ...
                  <TabPanels>
                    <TabPanel>
                      <Box w="full">
                        ...
                        <Transaction
                          source="Jeji"
                          transactionState="Idea Investment"
                          amount="12,000,000"
                          incoming={true}
                        />
  ...
  return (
    ...
    >
      <HStack alignItems="flex-start">
        ...
        >
          <Image
            src={incoming ? InflowIcon : InvestmentIcon}
      ...
      <Text fontWeight="700" fontColor={incoming ? "#AA0A0A" : "#2A5D19"}>
        SC {amount}
      </Text>
    </Box>
  );
