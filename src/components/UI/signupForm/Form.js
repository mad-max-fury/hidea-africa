    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <Stack spacing={4}>
                ...
                <FormInput name="password" type='password' icon={PasswordIcon} {...register("Password", {
                    required: true,
                    minLength: 8,
                    maxLength: 20
                })} />
